...
function generateEmail() {
    ...
    // Code Generator
    let templateCodeEN = emailCodeI+enI+clientName+emailCodeII+enII+emailCodeIII+enIII+emailCodeIV+checkoutLink+emailCodeV+enIV+emailCodeVI;
    let templateCodeRO = emailCodeI+ROI+clientName+emailCodeII+ROII+emailCodeIII+ROIII+emailCodeIV+checkoutLink+emailCodeV+ROIV+emailCodeVI;
    let templateCodeROfM = emailCodeI+ROfMI+clientName+emailCodeII+ROfMII+emailCodeIII+ROfMIII+emailCodeIV+checkoutLink+emailCodeV+ROfMIV+emailCodeVI;
    let templateCodeROfF = emailCodeI+ROfFI+clientName+emailCodeII+ROfFII+emailCodeIII+ROfFIII+emailCodeIV+checkoutLink+emailCodeV+ROfFIV+emailCodeVI;
